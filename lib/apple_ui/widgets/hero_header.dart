...
class HeroHeader extends StatelessWidget {
  ...
  final String asset; // png in assets/brand
        ...
        Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(subtitle, style: T.body.copyWith(color: Color(0xFFF0F3FF))),
              const Spacer(),
              if (onPrimary != null)
                Align(
                  ...
                  child: CupertinoButton(
                    ...
                    child: Text(
                      primaryLabel,
                      style: const TextStyle(color: Brand.primaryDark, fontWeight: FontWeight.w700),
                    ),
                  ),
                ),
            ],
